...
@section('content')
    {!! Form::open(['route' => ['admin.testify.masks.update', $masks->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
             @include('testify::admin.masks.partials.edit-fields')
